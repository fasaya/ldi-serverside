...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2020 at 04:49 AM
...
(11, 'DEPOSIT', 'apakah bisa deposit', '-', '0'),
...
(33, 'PINJAMAN', 'apakah bisa meminjam', '', '0'),
...
(37, 'SIMPANAN', 'apakah bisa menyimpan', '', '0'),
...
--
ALTER TABLE `login_history`
  MODIFY `id_log` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
