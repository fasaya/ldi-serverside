...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2020 at 11:49 AM
...
INSERT INTO `tb_anggota` (`id_anggota`, `id_parent`, `no_anggota`, `username`, `password`, `nama`, `email`, `tempat_lahir`, `tanggal_lahir`, `no_ktp`, `no_hp`, `alamat`, `kecamatan`, `kelurahan`, `kota`, `provinsi`, `kode_pos`, `pekerjaan`, `jabatan`, `perusahaan`, `alamat_perusahaan`, `kota_perusahaan`, `pendidikan`, `pass_tr`, `join_date`, `status`, `bank`, `no_rekening`) VALUES
(1, 0, '0000001', 'user1', '$2y$10$.3/i7AqXoyTCG/Np/TPx4OVlexVYIYFhA/xqWO2L5s.1as5Gbmjn2', 'Fasaya', 'andifasaya@gmail.com', 'Makassar', '12/04/2019', '123456', '0811415779', 'gdew', 'brae', 'rbea', 'bre', '', 0, 'dd', '', '', '', '', 'S1', '$2y$10$2SMU29G1BAULRC..fu913e.yfYGNYSl/EDDOVTnCI75BX2Df8.vSq', '2019-12-20 10:54:48', '9', 'BCA', '1234'),
(3, 1, '0000003', 'aminah', '$2y$10$z.JvPDXHcWCMMdoqJro/HOltVly/P1o93uDUkSskjqfwGct.5qady', 'sac', 'fasayaa@yahoo.com', 'sss', '01/21/2020', '12345678', '098721', 's', 'sd', 'vds', 'vd', 'sulsel', 90222, 'vsd', '', '', '', '', 'vsd', '$2y$10$z.JvPDXHcWCMMdoqJro/HOltVly/P1o93uDUkSskjqfwGct.5qady', '2020-01-05 21:48:59', '1', '', '');
...
(1, 'DP-0000001', 1, '30000000', '634', 1, 'LORCTN', '2020-01-07 17:49:41', '1');
...
INSERT INTO `tb_pinjaman` (`id_pinjaman`, `id_anggota`, `kode_tr`, `amount`, `bunga`, `jumlah_bunga`, `periode`, `angsuran`, `keterangan`, `date`, `start_date`, `status`) VALUES
(1, 1, 'PJ-0000001', '400000', '1', '0', 3, 2, '1234', '2020-01-07 17:51:47', '0000-00-00 00:00:00', '9');
...
(1, 'DP-0000001', 1, 1, '0', '30000000', '30000000', 'Deposit [DP-0000001] ke BCA - 12345689', 'depo_sukses', '2020-01-07 17:49:50'),
(2, 'SP-0000001', 1, 1, '250000', '0', '29750000', 'Membayar simpanan pokok', 'simpanan_POKOK', '2020-01-07 17:50:23'),
(3, 'SW-0000001', 1, 1, '50000', '0', '29700000', 'Membayar simpanan wajib', 'simpanan_wajib', '2020-01-07 17:50:29'),
(4, 'SW-0000002', 1, 2, '50000', '0', '29650000', 'Membayar simpanan wajib', 'simpanan_wajib', '2020-01-07 17:50:29'),
(5, 'SW-0000003', 1, 3, '50000', '0', '29600000', 'Membayar simpanan wajib', 'simpanan_wajib', '2020-01-07 17:50:29');
...
(1, '1', 'anggota', 'Permintaan deposit [DP-0000001] senilai Rp 30.000.000', '2020-01-07 17:49:41'),
(2, '16', 'pengurus', 'Deposit [DP-0000001] ke BCA - 12345689', '2020-01-07 17:49:50'),
(3, '1', 'anggota', 'Membayar simpanan pokok [SP-0000001]  senilai Rp 250.000', '2020-01-07 17:50:23'),
(4, '1', 'anggota', 'Membayar simpanan wajib 3 bulan senilai Rp 150.000', '2020-01-07 17:50:29'),
(5, '1', 'anggota', 'Mengajukan permohonan pinjaman [PJ-0000001]  senilai Rp 400.000', '2020-01-07 17:51:47'),
(6, '16', 'pengurus', 'Menolak Pinjaman [PJ-0000001] senilai Rp 0', '2020-01-07 17:51:59'),
(7, '16', 'pengurus', 'Update data anggota [0000003]', '2020-01-07 18:02:50');
...
INSERT INTO `tb_simpanan_pokok` (`id_simpanan`, `kode_tr`, `id_anggota`, `amount`, `date`) VALUES
(1, 'SP-0000001', 1, '250000', '2020-01-07 17:50:23');
...
INSERT INTO `tb_simpanan_wajib` (`id_simpanan`, `kode_tr`, `id_anggota`, `bulan_tahun`, `amount`, `date`) VALUES
(1, 'SW-0000001', 1, '2019-12-01', '50000', '2020-01-07 17:50:29'),
(2, 'SW-0000002', 1, '2020-01-01', '50000', '2020-01-07 17:50:29'),
(3, 'SW-0000003', 1, '2020-02-01', '50000', '2020-01-07 17:50:29');
...
--
ALTER TABLE `login_history`
  MODIFY `id_log` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
