...
(48, 24, '0000048', 'Ryan', '$2y$10$C8WiGqu3vdKvqztoTvVVFeDTTJrDVP/lCFUbWwYLbYST9QRkI7v5q', 'Sugiran', 'muhsugiran01@gmail.com', 'Ujung pandang', '1973-07-03', '7371010307730001', '085693662931', 'Paraikatte bajeng gowa', 'Bajeng', 'Desa paraikatte', 'Gowa', 'Sulawesi selatan', 0, 'Wiraswasta', '', '', '', '', 'Sma', '$2y$10$C8WiGqu3vdKvqztoTvVVFeDTTJrDVP/lCFUbWwYLbYST9QRkI7v5q', '2020-02-12 17:08:58', '1', '1', '', ''),
(49, 24, '0000049', 'Wirainkado', '$2y$10$5kf7.jCOtXvOB8TL1EFi1ezpujRgbBrawcoy66s7b83WtpPi9.zx2', 'Kasim kubo', 'wirainkado@gmail.com', 'Tatakalae', '1970-12-08', '7309130812700001', '085396984783', 'BTN Asabri blokb7 no.22', 'Moncongloe', 'Moncongloe lappara', 'Maros', 'Sulawesi selatan', 0, 'TNI AD', '', '', '', '', 'S1', '$2y$10$5kf7.jCOtXvOB8TL1EFi1ezpujRgbBrawcoy66s7b83WtpPi9.zx2', '2020-02-12 18:07:55', '1', '1', '', ''),
...
--
ALTER TABLE `login_history`
  MODIFY `id_log` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `tb_deposit`
  MODIFY `id_deposit` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tb_report_activity`
  MODIFY `id_activity` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
