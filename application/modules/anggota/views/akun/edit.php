        ...
        <div class="col-md-12">
            <section class="card">
                <header class="card-header">
                    <h2 class="card-title">Edit Data Rekening</h2>
                    <!-- <p class="card-subtitle">A bar chart is a way of summarizing a set of categorical data.</p> -->
                </header>
                <div class="card-body">
                    <form class="form-horizontal" action="<?= base_url() ?>anggota/akun/editbank" method="post">

                        <div class="form-group row">
                            <label class="col-lg-3 control-label text-lg-right pt-2">Bank</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="bank" placeholder="Nama Bank" value="<?= $data['bank']; ?>">
                                <?= form_error('bank', '<p class="text-danger mb-0 pb-0">', '</p>'); ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 control-label text-lg-right pt-2">Nomor Rekening</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="no_rekening" placeholder="Nomor Rekening" value="<?= $data['no_rekening']; ?>">
    ...
    <div class="row">
        <div class="col-md-6">
            <section class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?= base_url() ?>anggota/akun/editpass" method="post">
        ...
        <div class="col-md-6">
            <section class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?= base_url() ?>anggota/akun/editpasstr" method="post">

                        <div class="form-group row">
                            <label class="col-lg-3 control-label text-lg-right pt-2">Password Transaksi Lama</label>
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <span class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="password" class="form-control" name="passtr_lama" placeholder="Password Transaksi lama">
                                </div>
                                <?= form_error('passtr_lama', '<p class="text-danger mb-0 pb-0">', '</p>'); ?>
                            </div>
                        </div>
