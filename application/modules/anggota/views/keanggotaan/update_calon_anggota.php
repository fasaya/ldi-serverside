    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-right">
            <ol class="breadcrumbs mr-4">
                ...
                <li><span>Edit Calon Anggota</span></li>
            </ol>
        </div>
    </header>
            ...
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        Untuk mendaftarkan anggota, wajib membayar biaya administrasi sebesar<strong> Rp 25.000</strong>. Saldo anda saat ini adalah <strong>Rp <?= rupiah($this->Balance->total_balance()) ?></strong>.
                    </div>
                    <form class="form-horizontal" action="<?= base_url() ?>anggota/keanggotaan/editcalonanggota/<?= $data['no_anggota']; ?>" method="post">
