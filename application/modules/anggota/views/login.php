...
<head>
	...
	<meta name="keywords" content="Masuk Anggota Koperasi Lentera Digital Indonesia" />
		...
		<div class="center-sign">
			...
			<div class="panel card-sign">
				<div class="card-title-sign mt-3 text-right">
					<h2 class="title text-uppercase font-weight-bold m-0"><i class="fas fa-user mr-1"></i> Masuk Anggota</h2>
				</div>
				<div class="card-body">
					<form action="<?= site_url() ?>anggota/login/login" method="post">
						<!-- <div class="col-sm-12"> -->
						...
						<div class="form-group mb-3">
							<div class="clearfix">
								...
								<a href="<?= base_url() ?>reset" class="float-right">Lupa Password?</a>
							</div>
							<div class="input-group">
						...
						<div class="row">
							<div class="col-sm-12 text-left">
								<a href="<?= base_url() ?>register" class="float-left">Belum memiliki akun? Daftar disini!</a>
							</div>
						</div>
					</form>
				</div>
