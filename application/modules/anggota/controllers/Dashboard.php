...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // if ($this->Helper->cek_biaya_pendaftaran()) {
        //     $main['alert'] = TRUE;
        //     $main['keterangan'] .= '<li>Mengisi <strong><a href="' . base_url() . 'anggota/keanggotaan/pendaftaran" class="alert-link">Form Pendaftaran Anggota Baru</a></strong></li>';
        // }
        if ($this->Helper->cek_simpanan_wajib()) {
            $main['alert'] = TRUE;
            $main['keterangan'] .= '<li>Membayar <strong><a href="' . base_url() . 'anggota/simpanan" class="alert-link">Simpanan Wajib</a></strong></li>';
        }
        if ($this->Helper->cek_simpanan_pokok()) {
            $main['alert'] = TRUE;
            $main['keterangan'] .= '<li>Membayar <strong><a href="' . base_url() . 'anggota/simpanan" class="alert-link">Simpanan Pokok</a></strong></li>';
        } else {
            $main['alert'] = FALSE;
        }

        $main['username'] = $this->Helper->get_username();
