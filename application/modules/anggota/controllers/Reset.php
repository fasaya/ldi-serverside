...
class Reset extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $expires = date("U") + 1800;
            $url = base_url() . 'anggota/reset/createnewpassword/' . $selector . '/' . bin2hex($token);
            ...
            if ($query->num_rows() > 0) {
                ...
                if ($tokenCheck === FALSE) {
                    ...
                    if ($query2->num_rows() > 0) {
                        ...
                        $this->db->update('tb_anggota', $input, "id_anggota = " . $id_anggota);
                ...
                redirect('anggota/reset/createnewpassword/' . $selector . '/' . $validator);
            }
        }
    }
